...
var bootstrap = function ($, luoluo) {
    ...
    var meuns = {
        init: function () {
            var $menuwarp = $('.ll-frame-menu');
            $menuwarp.append('<em></em><div class="ll-second-menu-wrap" id="lr_second_menu_wrap"></div><div class="ll-frame-menu-overlay" id="lr_frame_menu_overlay"></div>');
            this.load();
            this.bind();
        },
        load: function () {
            ...
            for (var i = 0, l = modules.length; i < l; i++) {
                ...
                if (item.F_IsMenu == 1) {
                    ...
                    menuItemHtml += '<span class="ll-menu-item-arrow"></span></a>';
                    ...
                    if ($applistul.find('li').length > 0) {
                        ...
                        $(".ll-applist-slidebox-slider-content").append('<li><i class="fa fa-circle"></i></li>');
                    }
        ...
        bind: function () {
                ...
                switch (_module.F_Target) {
                    ...
                    case 'expand':
                        ...
                        if (!$li.hasClass('active')) {
                            ...
                            $li.addClass('active');
                            $('#lr_second_menu_wrap .ll-second-menu-list').hide();
                            $('#lr_second_menu_wrap .ll-second-menu-list[data-value="' + _module.F_ModuleId + '"]').show();
                        }
                        break;
                }
            });
            ...
            $(".ll-applist-slidebox-slider-content li").click(function () {
                var $this = $(this);
                if (!$this.hasClass("active")) {
                    var $oldli = $(".ll-applist-slidebox-slider-content li.active");
            ...
            $(".ll-applist-slidebox-slider-content li").eq(0).trigger('click');
            luoluo.frameTab.leaveFocus();
        },
        startMenuClick: function () {
            var $lr_frame_menu = $('.ll-frame-menu');
    ...
    luoluo.frameTab.opencallback = function () {
        meuns.closeApplist();
    };
    luoluo.frameTab.closecallback = function () {
