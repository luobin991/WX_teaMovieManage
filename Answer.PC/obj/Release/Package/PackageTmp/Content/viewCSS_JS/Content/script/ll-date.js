...
(function ($, luoluo) {
    ...
    $.extend(luoluo, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = luoluo.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = luoluo.parseDate(luoluo.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = luoluo.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = luoluo.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = luoluo.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = luoluo.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return luoluo.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
