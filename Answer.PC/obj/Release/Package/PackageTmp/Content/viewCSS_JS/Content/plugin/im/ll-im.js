...
(function ($, luoluo) {
    ...
    $.lrIM = {
        ...
        addMsgTolist: function (id, name, msg, img) {
            ...
            if ($item.length > 0) {
                ...
                _html += '';
                _html += '<div class="ll-im-onemsg">';
                _html += '<p class="ll-im-onemsg-title">' + name + '</p>';
                _html += '<p class="ll-im-onemsg-content">' + msg + '</p>';
                _html += '</div></li>';
            }
        }
        // 更新某一个聊天对象消息数量
    ...
    $._lrIM = {
        render: function () {
            var _html = '<div class="ll-im-icon"  ><a href="javascript:;" id="lr_imicon_btn" title="企业内部通讯"><i class="fa fa-commenting"></i><span class="label label-success"></span></a></div>';
            _html += '<div class="ll-im-wrap" >';
            /*联系人列表*/
            _html += '<div class="ll-im-user-list" style="display:none;" id="learun_im_list" >';
            _html += '<div class="ll-im-header">企业内部通讯<div class="ll-im-close"><a id="learun_im_close" href="javascript:;">×</a></div></div>';
            _html += '<div class="ll-im-search"><input type="text" placeholder="搜索：同事名称、讨论组名称"><i class="fa fa-search"></i></div>';

            _html += '<div class="ll-im-body">';

            _html += '<div class="ll-im-body-nav" id="learun_im_list_nav" ><ul>';
            ...
            _html += '<div class="ll-im-body-list" id="learun_im_body_list">';

            
               

            _html += '<ul id="learun_im_last_list" class="active" ></ul>';
            _html += '<ul id="learun_im_user_list" style="display:none;" ><li id="learun_im_mydepartment"><a class="ll-im-item"><i class="fa fa-caret-right"></i><span>本部门</span><em> 0/0 </em></a><ul class="luoluo-im-chatlist"></ul></li></ul>';
            _html += '<ul id="learun_im_group_list" style="display:none;" ></ul>';

            _html += '</div>';

            _html += '</div>';//<div class="ll-im-body">
            _html += '</div>';//<div class="ll-im-user-list">

            /*聊天窗口*/
            _html += '<div class="ll-im-window" style="display:none;" id="learun_im_window">';

            _html += '<div class="ll-im-window-header"><span class="text"></span><div class="close"><a href="javascript:;">×</a></div></div>';
            _html += '<div class="ll-im-window-tool"><a class="ll-im-window-tool-face " title="选择表情"><i class="fa fa-meh-o"></i></a></div>';
            _html += '<div class="ll-im-window-send"><textarea autofocus="" placeholder="按回车发送消息,shift+回车换行"></textarea></div>'
...
(function ($, luoluo) {
    ...
    $.imServer = {
        ...
        , getUserInfo: function (callback) {
            userinfo = luoluo.clientdata.get(['userinfo']);
            if (!!userinfo) {
                callback();
            }
            else {
