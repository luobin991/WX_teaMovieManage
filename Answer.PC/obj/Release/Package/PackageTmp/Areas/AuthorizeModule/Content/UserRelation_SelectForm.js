...
var bootstrap = function ($, luoluo) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $("#txt_keyword").keydown(function (event) {
                if (event.keyCode == 13) {
                    ...
                    if (keyword != "") {
                        luoluo.httpAsync('GET', top.$.rootUrl + '/SystemModule/SysUser/GetList', { keyword: keyword }, function (data) {
                            renderUserlist(data || []);
                        });
                    }
                }
        ...
        initData: function () {
            //if (!!companyId) {
            //    $('#company_select').llselectSet(companyId);
            //}
            //if (!!departmentId) {
            //    $('#department_tree').lltreeSet('setValue', departmentId);
            //}
            ...
            luoluo.httpAsync('GET', top.$.rootUrl + '/SystemModule/SysUser/GetList', { keyword: "" }, function (data) {
                renderUserlist(data || []);
            });
        }
    };
    ...
    acceptClick = function () {
        $.llSaveForm(top.$.rootUrl + '/AuthorizeModule/UserRelation/SaveForm', { objectId: objectId, category: category, userIds: String(userlistselected) }, function (res) { });
        return true;
    };
    page.init();
}