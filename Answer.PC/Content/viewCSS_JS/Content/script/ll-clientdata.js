 ...
 *dataItem--------------------数据字典
 luoluo.clientdata.getAsync('dataItem', {
            key: value,
            itemCode:itemCode,
            callback: function (_data) {
                _data.F_ItemName
 ...
 *custmerData-----------------自定义数据
 luoluo.clientdata.getAsync('custmerData', {
        url: url,
        key: value,
        valueId: valueId,
        callback: function (item) {
...
(function ($, luoluo) {
    ...
    luoluo.clientdata = {
        init: function (fn) {
            ...
            if (res == loadSate.yes) {
                ...
                setTimeout(luoluo.clientdata.init, 100);// 如果还在加载100ms后再检测
            }
            else {
                // 加载失败后处理
                callback(false);
    ...
    clientDataFn.modules = {
        ...
        init: function () {
            ...
            luoluo.httpAsyncGet($.rootUrl + '/SystemModule/Module/GetModuleList', function (res) {
    ...
    clientDataFn.userinfo = {
        ...
        init: function () {
            ...
            luoluo.httpAsyncGet($.rootUrl + '/Login/GetUserInfo', function (res) {
                if (res.code == luoluo.httpCode.success) {
    ...
    //    },
    //    load: function () {
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/Company/GetList', null, function (data) {
    //            if (!!data) {
    ...
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/Department/GetList', { companyId: companyId }, function (data) {
    //            if (!!data) {
    ...
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/Department/GetEntity', { departmentId: departmentId }, function (data) {
    //            if (!!data) {
    ...
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/User/GetUserEntity', { userId: userId }, function (data) {
    //            if (!!data) {
    ...
    //    },
    //    load: function () {
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DatabaseLink/GetList', null, function (data) {
    //            if (!!data) {
    //                clientData['db'] = data;
    //            }
    ...
    //        luoluo.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DataItem/GetDetailList', { itemCode: itemCode }, function (data) {
    //            if (!!data) {
    ...
    //    },
    //    load: function (url) {
    //        luoluo.httpAsync('GET', top.$.rootUrl + url, {}, function (data) {
    //            if (!!data) {
    //                clientData[url] = data;
    //            }
