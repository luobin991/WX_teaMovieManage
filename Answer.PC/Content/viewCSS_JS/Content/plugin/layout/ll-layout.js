/*
 * 日 期：2017.04.12
 * 描 述：lrLayout 页面布局插件（目前支持左右布局，新的布局请联系售后人员）
 */
(function ($, luoluo) {
    "use strict";
    ...
    $.fn.lrLayout = function (op) {
        ...
        for (var i = 0, l = dfop.blocks.length; i < l; i++) {
            ...
            $this.children(_block.target).append('<div class="ll-layout-move ll-layout-move-' + _block.type + ' " path="' + i + '"  ></div>');
        }
