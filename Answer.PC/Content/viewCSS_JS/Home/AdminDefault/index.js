...
var bootstrap = function ($, luoluo) {
    ...
    var meuns = {
        ...
        bind: function () {
            ...
            $("#lr_frame_menu .ll-first-menu-list > li").hover(function (e) {// 一级菜单选中的时候判断二级菜单的位置
                $('#lr_frame_menu').width(4000);
                var $secondMenu = $(this).find('.ll-second-menu-list');
            ...
            $("#lr_frame_menu .ll-second-menu-list > li.ll-meun-had").hover(function (e) {// 二级菜单选中的时候判断三级菜单的位置
                var $ul = $(this).find('.ll-three-menu-list');
                $ul.css('top', '-14px');
