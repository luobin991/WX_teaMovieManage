...
function GooFlow(bgDiv, property) {
    ...
    if (this.$editable) {
        ...
        //格式function(id，type)：id是单元的唯一标识ID,type是连接线的新类型,"sl":直线,"ll":中段可左右移动的折线,"tb":中段可上下移动的折线
    ...
    initDraw: function (id, width, height) {
        ...
        if (this.$editable) {
            ...
            $(this.$draw).delegate(tmpClk, "dblclick", { inthis: this }, function (e) {
                ...
                //    to = [n[2], n[3]];
                //}
                //if (This.$lineData[this.id].type == "ll") {
