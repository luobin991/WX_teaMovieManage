...
namespace Answer.PC
{
    ...
    public class MvcControllerBase : Controller
    {
        ...
        /// <summary>
        /// 根据影响行数返回 Success. or Fail
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        protected virtual new ActionResult Response(int result)
        {
            return result > 0 ? Success("操作成功") : Fail("操作失败");
        }
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        protected virtual new ActionResult Response(bool result)
        {
