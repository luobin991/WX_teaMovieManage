...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        /*绑定事件和初始化控件*/
        bind: function () {
            learun.httpAsyncGet(top.$.rootUrl + '/SystemModule/Module/GetCheckTree', function (res) {
                if (res.code == 200) {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        $('#step-2 .lr-tree-root [id$="_luo_moduleId"]').parent().hide();
                        $('#step-3 .lr-tree-root [id$="_luo_moduleId"]').parent().hide();
        ...
        initData: function () {
            if (!!objectId) {
                $.lrSetForm(top.$.rootUrl + '/AuthorizeModule/Authorize/GetFormData?objectId=' + objectId, function (data) {//
                    selectData = data;
                });
            }
        },
        ...
        save: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/AuthorizeModule/Authorize/SaveForm', postData, function (res) { });
        }
    };
