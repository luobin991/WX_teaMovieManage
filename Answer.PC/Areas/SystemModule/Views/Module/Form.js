...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/SystemModule/Module/GetFormData?keyValue=' + keyValue, function (data) {//
        ...
        save: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/SystemModule/Module/SaveForm', postData, function (res) {
                // 保存成功后才回调
